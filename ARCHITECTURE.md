...
**Cost learning.** After several generations with a model, the system derives a median cost from your own metered usage — per model, per parameter configuration. Learned costs fill gaps where curated pricing supplements aren't available. Estimates age out after 60 days of inactivity.
